...
@Component({
  selector: 'app-mymonstergrid',
  templateUrl: './mymonstergrid.component.html',
  styleUrls: ['./mymonstergrid.component.scss']
})
export class MyMonsterGridComponent implements OnInit, AfterViewInit {
